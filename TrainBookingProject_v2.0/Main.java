...
public class Main {
    public static void main(String[] args) {
        ...
        while (current_LoginedUser == null) {
            ...
            while (current_LoginedUser != null && current_LoginedUser.getRole() == "admin") {
                ...
                System.out.println("7. Update & publish an announcement");
                System.out.println("8. Cancel announcement");
    ...
    // private static void manageTrainSchedule(TrainTicketSystem system, Scanner
    // scanner) {
    ...
    // Train newTrain = new Train(trainID, departure, arrival, date, time,
    // totalSeats, price);
    ...
    // System.out.print("Enter New Departure Station (Current: " +
    // existingTrain.getDeparture() + "): ");
    // String departure = scanner.nextLine();
    // if (!departure.isEmpty()) {
    // existingTrain.setDeparture(departure);
    // }

    // System.out.print("Enter New Arrival Station (Current: " +
    // existingTrain.getArrival() + "): ");
    // String arrival = scanner.nextLine();
    // if (!arrival.isEmpty()) {
    // existingTrain.setArrival(arrival);
    // }

    // System.out.print("Enter New Departure Date (YYYY-MM-DD) (Current: " +
    // existingTrain.getDate() + "): ");
    // String date = scanner.nextLine();
    // if (!date.isEmpty()) {
    // existingTrain.setDate(date);
    // }

    // System.out.print("Enter New Departure Time (HH:MM) (Current: " +
    // existingTrain.getTime() + "): ");
    // String time = scanner.nextLine();
    // if (!time.isEmpty()) {
    // existingTrain.setTime(time);
    // }

    // System.out.print("Enter New Total Seats (Current: " +
    // existingTrain.getAvailableSeats() + "): ");
    ...
    // } else {
    // System.out.println("Total seats must be a positive number. Skipping update
    // for seats.");
    // }
    // } catch (NumberFormatException e) {
    // System.out.println("Invalid number format for seats. Skipping update for
    // seats.");
    // }
    // }

    // System.out.print("Enter New Ticket Price (Current: " +
    // existingTrain.getPrice() + "): ");
    ...
    // }
    // } catch (NumberFormatException e) {
    // System.out.println("Invalid number format for price. Skipping update for
    // price.");
    // }
    // }
